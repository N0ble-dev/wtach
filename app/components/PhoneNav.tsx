        ...
        {openNavigation && (
          ...
          >
            <MaxWidthWrapper className="relative z-[999] mt-20 my-auto h-full w-full flex gap-5 flex-col items-center justify-start mx-auto lg:flex-row">
              {[...navigation, { name: "contact us", href: "/contact-us" }].map(
                (link: { name: string; href: string }, i: number) => (
...
const MenuSvg = ({ openNavigation, isHome }: { openNavigation: boolean; isHome?: boolean }) => {
  return (
